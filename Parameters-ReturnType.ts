...
/**
ReturnType<Type>
Constructs a type consisting of the return type of function Type, i.e based on whatever are the types of the values returned from the function.
as usual hover over both answers to see their results
*/
